...
Elm.Main.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var Banana = function (a) {    return {ctor: "Banana",_0: a};};
   var Apple = function (a) {    return {ctor: "Apple",_0: a};};
   var main = function () {
      var y = _U.list([Apple(_U.list([1,2,3]))
                      ,Banana(_U.list([4,5,6]))]);
      var _p0 = A2($PrettyDebug.log,"A dict",y);
      return $Graphics$Element.show("Hello, World!");
   }();
